...
$result = mysql_query("SELECT MatricNo, FullName, status FROM patient where status='not treat'");
                ...
                <tbody> 
				   <?php 
                    ...
                    <tr class="gradeA">
						...
						<td><a href="consult.php<?php echo '?MatricNo='.$db_field['MatricNo']; ?>" >CONSULT  
						<a href="update_status.php<?php echo '?MatricNo='.$db_field['MatricNo']; ?>" >UPDATE</td>
